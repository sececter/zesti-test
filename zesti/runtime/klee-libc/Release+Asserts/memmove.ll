...
entry:
  ...
  tail call void @llvm.dbg.value(metadata !{i64 %count}, i64 0, metadata !11), !dbg !19
...
bb2:                                              ; preds = %bb3.preheader, %bb2
  ...
  %exitcond21 = icmp eq i64 %indvar.next20, %count
...
bb5:                                              ; preds = %bb5.lr.ph, %bb5
  ...
  %tmp18 = sub i64 %tmp17, %indvar
  %b.112 = getelementptr i8* %src, i64 %tmp18
  %a.111 = getelementptr i8* %dst, i64 %tmp18
  %4 = load i8* %b.112, align 1, !dbg !28
  store i8 %4, i8* %a.111, align 1, !dbg !28
  %indvar.next = add i64 %indvar, 1
  %exitcond = icmp eq i64 %indvar.next, %count
...
!0 = metadata !{i32 589870, i32 0, metadata !1, metadata !"memmove", metadata !"memmove", metadata !"memmove", metadata !1, i32 12, metadata !3, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 true, i8* (i8*, i8*, i64)* @memmove} ; [ DW_TAG_subprogram ]
!1 = metadata !{i32 589865, metadata !"memmove.c", metadata !"/home/xqx/projects/zesti-test/zesti/runtime/klee-libc/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"memmove.c", metadata !"/home/xqx/projects/zesti-test/zesti/runtime/klee-libc/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
...
!7 = metadata !{i32 589865, metadata !"stddef.h", metadata !"/home/xqx/projects/llvm-gcc4.2-2.9-x86_64-linux/bin/../lib/gcc/x86_64-unknown-linux-gnu/4.2.1/include", metadata !2} ; [ DW_TAG_file_type ]
