...
entry:
  ...
  tail call void @llvm.dbg.value(metadata !{i64 %count}, i64 0, metadata !12), !dbg !17
  ...
  %0 = icmp eq i64 %count, 0, !dbg !20
  br i1 %0, label %bb2, label %bb.lr.ph, !dbg !20

bb.lr.ph:                                         ; preds = %entry
  %1 = trunc i32 %s to i8, !dbg !21
  call void @llvm.memset.p0i8.i64(i8* %dst, i8 %1, i64 %count, i32 1, i1 false), !dbg !21
...
!0 = metadata !{i32 589870, i32 0, metadata !1, metadata !"memset", metadata !"memset", metadata !"memset", metadata !1, i32 12, metadata !3, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 true, i8* (i8*, i32, i64)* @memset} ; [ DW_TAG_subprogram ]
!1 = metadata !{i32 589865, metadata !"memset.c", metadata !"/home/xqx/projects/zesti-test/zesti/runtime/klee-libc/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"memset.c", metadata !"/home/xqx/projects/zesti-test/zesti/runtime/klee-libc/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
...
!8 = metadata !{i32 589865, metadata !"stddef.h", metadata !"/home/xqx/projects/llvm-gcc4.2-2.9-x86_64-linux/bin/../lib/gcc/x86_64-unknown-linux-gnu/4.2.1/include", metadata !2} ; [ DW_TAG_file_type ]
