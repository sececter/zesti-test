...
entry:
  ...
  tail call void @llvm.dbg.value(metadata !{i64 %n}, i64 0, metadata !12), !dbg !21
  %0 = icmp eq i64 %n, 0, !dbg !22
...
bb1:                                              ; preds = %bb1.preheader, %bb3
  ...
  %p.0 = getelementptr i8* %s, i64 %indvar
...
bb3:                                              ; preds = %bb1
  %4 = icmp eq i64 %tmp7, %indvar, !dbg !24
...
!0 = metadata !{i32 589870, i32 0, metadata !1, metadata !"memchr", metadata !"memchr", metadata !"memchr", metadata !1, i32 44, metadata !3, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 true, i8* (i8*, i32, i64)* @memchr} ; [ DW_TAG_subprogram ]
!1 = metadata !{i32 589865, metadata !"memchr.c", metadata !"/home/xqx/projects/zesti-test/zesti/runtime/klee-libc/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"memchr.c", metadata !"/home/xqx/projects/zesti-test/zesti/runtime/klee-libc/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
