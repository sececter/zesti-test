...
bb4:                                              ; preds = %entry, %bb4
  %indvar = phi i64 [ %tmp, %bb4 ], [ 0, %entry ]
  %l.18 = phi i8* [ %l.1, %bb4 ], [ %l.16, %entry ]
  %tmp = add i64 %indvar, 1
  %scevgep = getelementptr i8* %t, i64 %tmp
...
!1 = metadata !{i32 589865, metadata !"strrchr.c", metadata !"/home/xqx/projects/zesti-test/zesti/runtime/klee-libc/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"strrchr.c", metadata !"/home/xqx/projects/zesti-test/zesti/runtime/klee-libc/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
