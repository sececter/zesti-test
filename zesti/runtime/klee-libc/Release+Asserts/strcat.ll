...
bb:                                               ; preds = %entry, %bb
  %indvar6 = phi i64 [ %tmp, %bb ], [ 0, %entry ]
  %tmp = add i64 %indvar6, 1
  %scevgep = getelementptr i8* %s, i64 %tmp
...
bb2:                                              ; preds = %bb2.preheader, %bb2
  %indvar = phi i64 [ 0, %bb2.preheader ], [ %indvar.next, %bb2 ]
  %append_addr.0 = getelementptr i8* %append, i64 %indvar
  %s_addr.1 = getelementptr i8* %s_addr.0.lcssa, i64 %indvar
...
!1 = metadata !{i32 589865, metadata !"strcat.c", metadata !"/home/xqx/projects/zesti-test/zesti/runtime/klee-libc/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"strcat.c", metadata !"/home/xqx/projects/zesti-test/zesti/runtime/klee-libc/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
