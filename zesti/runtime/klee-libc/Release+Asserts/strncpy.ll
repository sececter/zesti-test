...
define i8* @strncpy(i8* %dst, i8* nocapture %src, i64 %n) nounwind {
entry:
  ...
  tail call void @llvm.dbg.value(metadata !{i64 %n}, i64 0, metadata !14), !dbg !19
  %0 = icmp eq i64 %n, 0, !dbg !20
...
bb1:                                              ; preds = %bb1.preheader, %bb4
  %1 = phi i64 [ 0, %bb1.preheader ], [ %indvar.next12, %bb4 ]
  %d.0 = getelementptr i8* %dst, i64 %1
  %s.0 = getelementptr i8* %src, i64 %1
...
bb3.preheader:                                    ; preds = %bb1
  ...
  %4 = icmp eq i64 %n_addr.0, 1, !dbg !22
  br i1 %4, label %bb5, label %bb2.lr.ph, !dbg !22

bb2.lr.ph:                                        ; preds = %bb3.preheader
  %tmp14 = sub i64 %tmp21, %1
  %tmp15 = add i64 %1, 1
  %scevgep = getelementptr i8* %dst, i64 %tmp15
  call void @llvm.memset.p0i8.i64(i8* %scevgep, i8 0, i64 %tmp14, i32 1, i1 false), !dbg !23
  tail call void @llvm.dbg.value(metadata !{null}, i64 0, metadata !15), !dbg !23
  tail call void @llvm.dbg.value(metadata !{null}, i64 0, metadata !14), !dbg !22
  br label %bb5

bb4:                                              ; preds = %bb1
  %5 = icmp eq i64 %tmp21, %1, !dbg !24
  %indvar.next12 = add i64 %1, 1
...
!0 = metadata !{i32 589870, i32 0, metadata !1, metadata !"strncpy", metadata !"strncpy", metadata !"strncpy", metadata !1, i32 43, metadata !3, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 true, i8* (i8*, i8*, i64)* @strncpy} ; [ DW_TAG_subprogram ]
!1 = metadata !{i32 589865, metadata !"strncpy.c", metadata !"/home/xqx/projects/zesti-test/zesti/runtime/klee-libc/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"strncpy.c", metadata !"/home/xqx/projects/zesti-test/zesti/runtime/klee-libc/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
...
!10 = metadata !{i32 589865, metadata !"stddef.h", metadata !"/home/xqx/projects/llvm-gcc4.2-2.9-x86_64-linux/bin/../lib/gcc/x86_64-unknown-linux-gnu/4.2.1/include", metadata !2} ; [ DW_TAG_file_type ]
