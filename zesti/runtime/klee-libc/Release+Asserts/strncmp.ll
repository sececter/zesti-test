...
define i32 @strncmp(i8* nocapture %s1, i8* nocapture %s2, i64 %n) nounwind readonly {
entry:
  ...
  tail call void @llvm.dbg.value(metadata !{i64 %n}, i64 0, metadata !14), !dbg !15
  %0 = icmp eq i64 %n, 0, !dbg !16
...
bb1:                                              ; preds = %bb1.preheader, %bb5
  %indvar = phi i64 [ 0, %bb1.preheader ], [ %indvar.next, %bb5 ]
  %s2_addr.0 = getelementptr i8* %s2, i64 %indvar
  %s1_addr.0 = getelementptr i8* %s1, i64 %indvar
...
bb5:                                              ; preds = %bb3
  %8 = icmp eq i64 %tmp15, %indvar, !dbg !21
...
!0 = metadata !{i32 589870, i32 0, metadata !1, metadata !"strncmp", metadata !"strncmp", metadata !"strncmp", metadata !1, i32 37, metadata !3, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 true, i32 (i8*, i8*, i64)* @strncmp} ; [ DW_TAG_subprogram ]
!1 = metadata !{i32 589865, metadata !"strncmp.c", metadata !"/home/xqx/projects/zesti-test/zesti/runtime/klee-libc/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"strncmp.c", metadata !"/home/xqx/projects/zesti-test/zesti/runtime/klee-libc/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
