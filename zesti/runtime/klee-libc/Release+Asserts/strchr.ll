...
bb:                                               ; preds = %bb4, %entry
  %indvar = phi i64 [ %indvar.next, %bb4 ], [ 0, %entry ]
  %p_addr.0 = getelementptr i8* %p, i64 %indvar
...
!1 = metadata !{i32 589865, metadata !"strchr.c", metadata !"/home/xqx/projects/zesti-test/zesti/runtime/klee-libc/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"strchr.c", metadata !"/home/xqx/projects/zesti-test/zesti/runtime/klee-libc/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
