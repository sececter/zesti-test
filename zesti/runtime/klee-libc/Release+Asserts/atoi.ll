...
entry:
  ...
  %0 = tail call i64 @strtol(i8* noalias nocapture %str, i8** noalias null, i32 10) nounwind, !dbg !11
  %1 = trunc i64 %0 to i32, !dbg !11
  ret i32 %1, !dbg !11
}
...
!1 = metadata !{i32 589865, metadata !"atoi.c", metadata !"/home/xqx/projects/zesti-test/zesti/runtime/klee-libc/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"atoi.c", metadata !"/home/xqx/projects/zesti-test/zesti/runtime/klee-libc/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
