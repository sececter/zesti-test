...
entry:
  ...
  tail call void @klee_warning_once(i8* getelementptr inbounds ([34 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !32
  %0 = load i32* @NumAtExit, align 4, !dbg !34
  %1 = icmp eq i32 %0, 128, !dbg !34
  br i1 %1, label %bb, label %bb1, !dbg !34

bb:                                               ; preds = %entry
  tail call void @klee_report_error(i8* getelementptr inbounds ([15 x i8]* @.str1, i64 0, i64 0), i32 39, i8* getelementptr inbounds ([32 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str3, i64 0, i64 0)) noreturn nounwind, !dbg !35
  unreachable, !dbg !35

bb1:                                              ; preds = %entry
  %2 = zext i32 %0 to i64, !dbg !36
  %3 = getelementptr inbounds [128 x %struct.anon]* @AtExit, i64 0, i64 %2, i32 0, !dbg !36
  store void (i8*)* %fn, void (i8*)** %3, align 8, !dbg !36
  %4 = getelementptr inbounds [128 x %struct.anon]* @AtExit, i64 0, i64 %2, i32 1, !dbg !37
  store i8* %arg, i8** %4, align 8, !dbg !37
  %5 = add i32 %0, 1, !dbg !38
  store i32 %5, i32* @NumAtExit, align 4, !dbg !38
  ret i32 0, !dbg !39
}
...
bb:                                               ; preds = %entry, %bb
  %2 = phi i32 [ %tmp, %bb ], [ 0, %entry ]
  %tmp = add i32 %2, 1
  %3 = zext i32 %2 to i64, !dbg !42
  %4 = getelementptr inbounds [128 x %struct.anon]* @AtExit, i64 0, i64 %3, i32 0, !dbg !42
  %5 = load void (i8*)** %4, align 8, !dbg !42
  %6 = getelementptr inbounds [128 x %struct.anon]* @AtExit, i64 0, i64 %3, i32 1, !dbg !42
  %7 = load i8** %6, align 8, !dbg !42
  tail call void %5(i8* %7) nounwind, !dbg !42
  %8 = load i32* @NumAtExit, align 4, !dbg !41
  %9 = icmp ult i32 %tmp, %8, !dbg !41
  br i1 %9, label %bb, label %return, !dbg !41
...
!1 = metadata !{i32 589865, metadata !"__cxa_atexit.c", metadata !"/home/xqx/projects/zesti-test/zesti/runtime/klee-libc/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"__cxa_atexit.c", metadata !"/home/xqx/projects/zesti-test/zesti/runtime/klee-libc/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
...
!17 = metadata !{i32 589825, metadata !1, metadata !"", metadata !1, i32 0, i64 24576, i64 64, i64 0, i32 0, metadata !18, metadata !23, i32 0, null} ; [ DW_TAG_array_type ]
!18 = metadata !{i32 589843, metadata !1, metadata !"", metadata !1, i32 14, i64 192, i64 64, i64 0, i32 0, null, metadata !19, i32 0, null} ; [ DW_TAG_structure_type ]
!19 = metadata !{metadata !20, metadata !21, metadata !22}
!20 = metadata !{i32 589837, metadata !18, metadata !"fn", metadata !1, i32 15, i64 64, i64 64, i64 0, i32 0, metadata !9} ; [ DW_TAG_member ]
!21 = metadata !{i32 589837, metadata !18, metadata !"arg", metadata !1, i32 16, i64 64, i64 64, i64 64, i32 0, metadata !12} ; [ DW_TAG_member ]
!22 = metadata !{i32 589837, metadata !18, metadata !"dso_handle", metadata !1, i32 17, i64 64, i64 64, i64 128, i32 0, metadata !12} ; [ DW_TAG_member ]
