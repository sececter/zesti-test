...
entry:
  ...
  call void @klee_make_symbolic(i8* %x1, i64 4, i8* %name) nounwind, !dbg !14
...
!1 = metadata !{i32 589865, metadata !"klee_int.c", metadata !"/home/xqx/projects/zesti-test/zesti/runtime/Intrinsic/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"klee_int.c", metadata !"/home/xqx/projects/zesti-test/zesti/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
