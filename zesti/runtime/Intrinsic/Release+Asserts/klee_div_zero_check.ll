...
entry:
  ...
  %0 = tail call i32 (...)* @klee_enable_symbex(i32 2, i32 1) nounwind, !dbg !8
  %1 = icmp eq i64 %z, 0, !dbg !10
  br i1 %1, label %bb, label %bb1, !dbg !10

bb:                                               ; preds = %entry
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str, i64 0, i64 0), i32 16, i8* getelementptr inbounds ([15 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str2, i64 0, i64 0)) noreturn nounwind, !dbg !11
  unreachable, !dbg !11

bb1:                                              ; preds = %entry
  tail call void @klee_disable_symbex() nounwind, !dbg !12
  ret void, !dbg !13
}
...
!1 = metadata !{i32 589865, metadata !"klee_div_zero_check.c", metadata !"/home/xqx/projects/zesti-test/zesti/runtime/Intrinsic/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"klee_div_zero_check.c", metadata !"/home/xqx/projects/zesti-test/zesti/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
...
!8 = metadata !{i32 14, i32 0, metadata !9, null}
!9 = metadata !{i32 589835, metadata !0, i32 12, i32 0, metadata !1, i32 0} ; [ DW_TAG_lexical_block ]
!10 = metadata !{i32 15, i32 0, metadata !9, null}
!11 = metadata !{i32 16, i32 0, metadata !9, null}
!12 = metadata !{i32 17, i32 0, metadata !9, null}
!13 = metadata !{i32 18, i32 0, metadata !9, null}
