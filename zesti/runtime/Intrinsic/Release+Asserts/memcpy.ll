...
entry:
  ...
  tail call void @llvm.dbg.value(metadata !{i64 %len}, i64 0, metadata !11), !dbg !19
...
bb:                                               ; preds = %entry, %bb
  ...
  %exitcond = icmp eq i64 %indvar.next, %len
  br i1 %exitcond, label %bb2, label %bb, !dbg !23

bb2:                                              ; preds = %bb, %entry
  ret i8* %destaddr, !dbg !25
}
...
!0 = metadata !{i32 589870, i32 0, metadata !1, metadata !"memcpy", metadata !"memcpy", metadata !"memcpy", metadata !1, i32 12, metadata !3, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 true, i8* (i8*, i8*, i64)* @memcpy} ; [ DW_TAG_subprogram ]
!1 = metadata !{i32 589865, metadata !"memcpy.c", metadata !"/home/xqx/projects/zesti-test/zesti/runtime/Intrinsic/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"memcpy.c", metadata !"/home/xqx/projects/zesti-test/zesti/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
