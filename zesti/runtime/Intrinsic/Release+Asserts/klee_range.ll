...
bb3:                                              ; preds = %bb1
  ...
  call void @klee_make_symbolic(i8* %x4, i64 4, i8* %name) nounwind, !dbg !19
...
bb5:                                              ; preds = %bb3
  ...
  %6 = zext i1 %5 to i64, !dbg !21
  call void @klee_assume(i64 %6) nounwind, !dbg !21
  br label %bb7, !dbg !21

bb6:                                              ; preds = %bb3
  %7 = icmp sge i32 %4, %start, !dbg !22
  %8 = zext i1 %7 to i64, !dbg !22
  call void @klee_assume(i64 %8) nounwind, !dbg !22
  %9 = load i32* %x, align 4, !dbg !23
  %10 = icmp slt i32 %9, %end, !dbg !23
  %11 = zext i1 %10 to i64, !dbg !23
  call void @klee_assume(i64 %11) nounwind, !dbg !23
  br label %bb7, !dbg !23
...
!1 = metadata !{i32 589865, metadata !"klee_range.c", metadata !"/home/xqx/projects/zesti-test/zesti/runtime/Intrinsic/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"klee_range.c", metadata !"/home/xqx/projects/zesti-test/zesti/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
